...
```{r echo=FALSE, molarextsolutions, out.width='70%', fig.show='hold', fig.align='center', fig.cap='1 mM solutions of the organic dye methylene blue (right), potassium permanganate (centre) and copper hexa-aqua (left).'}
